const styles = {
    ...
    heading: 'text-[27px] text-center text-teal-300 md:text-start font-[600] font-Roboto pb-[20px]',
    section:'w-11/12 mr-12',
    ...
    button: 'w-[150px] bg-blue-700 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
